...
from xianyu_bot_components.core.xianyu_client import XianyuClient
from xianyu_bot_components.core.context_manager import ChatContextManager
from xianyu_bot_components.agents.xianyu_agent import XianyuReplyBot
from xianyu_bot_components.utils.xianyu_utils import (
...
class XianyuBot:
    ...
    def __init__(self, cookies_str):
        self.client = XianyuClient(cookies_str)
        ...
        self.reconnect_base_delay = int(os.getenv("RECONNECT_BASE_DELAY", "5"))
        self.reconnect_max_delay = int(os.getenv("RECONNECT_MAX_DELAY", "60"))
        ...
        self.toggle_keywords = os.getenv("TOGGLE_KEYWORDS", "闲鱼").split(",")  # 人工接管切换关键词
...
def test_cookies_validity(cookies_str):
    """测试cookies是否有效"""
    try:
        from xianyu_bot_components.utils.xianyu_utils import trans_cookies, generate_device_id
        from xianyu_bot_components.utils.xianyu_apis import XianyuApis
